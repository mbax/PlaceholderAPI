# PlaceholderAPI [![Download](https://img.shields.io/badge/download-1.0--SNAPSHOT-green.svg)]([![Build Status](https://travis-ci.org/AniOrg/PlaceholderAPI.svg?branch=master)](https://travis-ci.org/AniOrg/PlaceholderAPI)
